...
function MessageCard({ isActive }) {
  ...
  const message = `Hello Aanshi,

  Happy Birthday! I hope today brings you lots of smiles, laughter, and little moments that make you feel truly celebrated. You deserve a day filled with warmth and good surprises.

Another year older means another year of memories, growth, and new adventures ahead. May this year bring you confidence, happiness, and many reasons to be proud of yourself.

Wishing you a bright year full of good health, great friends, and dreams that keep moving closer. Enjoy every moment of your special day! 🎉
