    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Aanshi</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Aanshi's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Happy Birthday! Today is all about celebrating you and the amazing person you are.<br/> I love you so much 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Krushil 💖</h2>
          <p className="final-subtitle">Wishing you endless joy today and always—enjoy every moment of your special day. ✨</p>
        </section>
      </div>
